...
describe('Events API Routes', () => {
  ...
  describe('GET /api/events', () => {
    ...
    it('should filter events by category', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/events?category=networking')
      await GET(request)
    ...
    it('should filter events by search term', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/events?search=tech')
      await GET(request)
