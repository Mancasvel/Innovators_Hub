...
function generateHMAC(qrCode) {
  const secret = process.env.SECRET_TICKET_KEY || 'default-secret-key-for-testing';
...
async function seedDatabase() {
  try {
    ...
    const event1 = await Event.create({
      ...
      description: 'Learn the fundamentals of blockchain technology and Web3 development. Perfect for beginners who want to enter the decentralized world.',
    ...
    const event2 = await Event.create({
      ...
      description: 'Connect with fellow digital nomads, share experiences, and build meaningful relationships in Seville\'s vibrant tech community.',
