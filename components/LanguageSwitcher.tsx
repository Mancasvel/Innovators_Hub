      ...
      >
        <button
          ...
          className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 flex items-center gap-3 ${
            currentLocale === 'es' ? 'text-seville-orange bg-orange-50' : 'text-gray-700'
          }`}
        >
          ...
          {currentLocale === 'es' && (
            <svg className="w-4 h-4 text-seville-orange ml-auto" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button
          ...
          className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-50 flex items-center gap-3 ${
            currentLocale === 'en' ? 'text-seville-orange bg-orange-50' : 'text-gray-700'
          }`}
        >
          <span className="text-lg">🇬🇧</span>
          <div>
